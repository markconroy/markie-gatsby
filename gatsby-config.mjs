...
const config = {
  siteMetadata: {
    title: `Markie`,
    description: `Mark Conroy: Drupal core maintainer, LocalGov Drupal frontend Lead, and Design Systems consultant.`,
    author: `@markconroy`,
            ...
            query: `
              {
                allNodeArticle(
                  sort: {created: DESC}
                  filter: {relationships: {field_tags: {elemMatch: {name: {eq: "Drupal Planet"}}}}}
                ) {
                  edges {
                    node {
                      id
